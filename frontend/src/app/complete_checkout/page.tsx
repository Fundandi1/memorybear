        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          {orderStatus === 'loading' && (
            <>
              ...
              <h1 className="text-3xl font-serif text-gray-800 mb-4">Bekræfter din ordre...</h1>
          ...
          {orderStatus === 'success' && (
            <>
              ...
              <h1 className="text-3xl font-serif text-gray-800 mb-4">Tak for din bestilling!</h1>
          ...
          {orderStatus === 'failed' && (
            <>
              ...
              <h1 className="text-3xl font-serif text-gray-800 mb-4">Der opstod en fejl</h1>
          ...
          {orderStatus === 'pending' && (
            <>
              ...
              <h1 className="text-3xl font-serif text-gray-800 mb-4">Afventer bekræftelse</h1>
          ...
          {orderStatus === 'error' && (
            <>
              ...
              <h1 className="text-3xl font-serif text-gray-800 mb-4">Noget gik galt</h1>
